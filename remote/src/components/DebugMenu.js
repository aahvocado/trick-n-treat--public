...
export default observer(
  class DebugMenu extends Component {
    ...
    render() {
      ...
      return (
        <FixedMenuComponent
          className='bg-secondary flex-col aitems-center width-full text-center'
          style={{
        ...
        >
          ...
          <div className='flex-row jcontent-center width-full sibling-mar-t-2'>
          ...
          <div className='width-full flex-col aitems-center sibling-mar-t-2'>
            ...
            <textarea
              readOnly
              className='fsize-2 bor-1-gray borradius-1 pad-1 width-full flex-auto'
              style={{
                height: '220px',
                resize: 'none',
                whiteSpace: 'pre-line',
...
const CloseMenuButton = withRouter(({label, history}) => (
  <ClassicButtonComponent
    className='width-full flex-row aitems-center sibling-mar-t-2'
